...
Reads:  data/raw/candles_BTC-EUR_5m.parquet
Writes: data/processed/realized_measures_btc_eur_v2.parquet
...
INPUT = PROJECT / 'data' / 'raw' / 'candles_BTC-EUR_5m.parquet'
OUT_DIR = PROJECT / 'data' / 'processed'
OUT_PARQUET = OUT_DIR / 'realized_measures_btc_eur_v2.parquet'
OUT_CSV = OUT_DIR / 'realized_measures_btc_eur_v2.csv'


def main():
    print("=" * 70)
    print("B2_recompute_realized.py — BTC-EUR realized measures v2")
    print("=" * 70)
